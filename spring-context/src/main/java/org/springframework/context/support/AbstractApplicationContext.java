...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	/** BeanFactoryPostProcessors 应用于刷新 */
	...
	public AbstractApplicationContext() {
		// 调用AbstractApplicationContext实例的getResourcePatternResolver方法
	...
	protected void prepareRefresh() {
		...
		// 切换企业实战后（执行 AbstractRefreshableWebApplicationContext），再详细深解
		initPropertySources();
		...
		// 译文：允许收集早期的ApplicationEvents，一旦多播可用，就可以发布它们……
	...
	protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
		/** Demo不涉及-start */
		// SpringMVC 相关；conversionService用于在接收前端的请求参数时，进行数据的转换
		...
		// 一般都是用<context:property-placeholder/>，来隐式注册 PropertyPlaceholderConfigurer 来读取${}
	...
	/**
	 * 根据给定的字符串路径locationPattern，解析配置文件，返回资源实例，一个Resource代表一个文件
	 *
	...
	public Resource[] getResources(String locationPattern) throws IOException {
		// resourcePatternResolver代表的是 PathMatchingResourcePatternResolver 实例
